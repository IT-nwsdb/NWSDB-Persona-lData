...
const SECTION_SCHEMAS = {
  ...
  "contract": {
    fieldIds: ["c_name", "c_bday", "c_nic", "c_address", "c_phone", "c_contractNo", "c_contractor", "c_contractType", "c_category"],
    hasForm: true,
  },
  "lrdc": {
  ...
  "cleaning-service": {
    fieldIds: ["cs_name", "cs_bday", "cs_nic", "cs_address", "cs_phone", "cs_contractNo", "cs_contractor", "cs_contractType", "cs_category"],
    hasForm: true,
  },
  "trainee": {
